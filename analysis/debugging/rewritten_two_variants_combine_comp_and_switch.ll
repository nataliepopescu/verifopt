...
@vtable.4 = private unnamed_addr constant <{ [24 x i8], ptr }> <{ [24 x i8] c"\00\00\00\00\00\00\00\00\08\00\00\00\00\00\00\00\08\00\00\00\00\00\00\00", ptr @_RNvXs1g_NtCshhmRwEtsTQ2_4core3fmtRNtNtNtB8_3num5error12IntErrorKindNtB6_5Debug3fmtCsk5rB8Fy7VC3_12two_variants }>, align 8
...
common.resume:                                    ; preds = %bb11.i.i.i, %bb2.i.i.i.i.i, %bb2.i.i.i.i.i4.i.i.i.i.i, %bb15
  %common.resume.op = phi { ptr, i32 } [ %.pn6, %bb15 ], [ %.pn.i.i.i, %bb11.i.i.i ], [ %.pn.ph.i, %bb2.i.i.i.i.i ], [ %.pn.ph.i, %bb2.i.i.i.i.i4.i.i.i.i.i ]
...
_RNvXNtNtCsavYRE6QVrtQ_5alloc3vec21spec_from_iter_nestedINtB4_3VecNtNtB6_6string6StringEINtB2_18SpecFromIterNestedB11_NtNtCsefmIBSMl6ne_3std3env4ArgsE9from_iterCsk5rB8Fy7VC3_12two_variants.exit: ; preds = %bb2.i.i.i.i.i.i.i.i, %bb2.i.i.i.i.i4.i.i.i.i.i.i.i.i
  ...
  %_31 = icmp ult i64 %_3.pre, 384307168202282326
  call void @llvm.assume(i1 %_31)
  switch i64 %_3.pre, label %bb19 [
    i64 1, label %bb2
    i64 0, label %panic
  ]
...
; invoke std::io::stdio::_print
  invoke void @_RNvNtNtCsefmIBSMl6ne_3std2io5stdio6__print(ptr noundef nonnull @alloc_c85489ac7d65f986716cfdb1dc3aed62, ptr noundef nonnull inttoptr (i64 79 to ptr))
          to label %bb11.thread unwind label %cleanup

bb11.thread:                                      ; preds = %bb2
  %.phi.trans.insert58 = getelementptr inbounds nuw i8, ptr %args, i64 8
  %_1.val.i.pre = load ptr, ptr %.phi.trans.insert58, align 8, !alias.scope !125
  br label %bb5.i.i.i.preheader

bb15:                                             ; preds = %cleanup.i24, %_RNvXs_NtCsavYRE6QVrtQ_5alloc5allocNtB4_6GlobalNtNtCshhmRwEtsTQ2_4core5alloc9Allocator10deallocate.exit.i4.i25, %cleanup, %bb14
  %.pn6 = phi { ptr, i32 } [ %82, %bb14 ], [ %62, %cleanup ], [ %92, %_RNvXs_NtCsavYRE6QVrtQ_5alloc5allocNtB4_6GlobalNtNtCshhmRwEtsTQ2_4core5alloc9Allocator10deallocate.exit.i4.i25 ], [ %92, %cleanup.i24 ]
; call core::ptr::drop_in_place::<alloc::vec::Vec<alloc::string::String>>
...
bb11:                                             ; preds = %bb3.i27, %_RNvXs_NtCsavYRE6QVrtQ_5alloc5allocNtB4_6GlobalNtNtCshhmRwEtsTQ2_4core5alloc9Allocator10deallocate.exit.i.i28
  call void @llvm.experimental.noalias.scope.decl(metadata !125)
  call void @llvm.experimental.noalias.scope.decl(metadata !128)
  %_710.i.i.i = icmp eq i64 %_3.pre, 0
  br i1 %_710.i.i.i, label %bb4.i, label %bb5.i.i.i.preheader

bb5.i.i.i.preheader:                              ; preds = %bb11.thread, %bb11
  %_1.val.i64 = phi ptr [ %_1.val.i.pre, %bb11.thread ], [ %_35, %bb11 ]
  br label %bb5.i.i.i
...
bb5.i.i.i:                                        ; preds = %bb5.i.i.i.preheader, %_RINvNtCshhmRwEtsTQ2_4core3ptr13drop_in_placeNtNtCsavYRE6QVrtQ_5alloc6string6StringECsk5rB8Fy7VC3_12two_variants.exit.i.i.i
  ...
  %_6.i.i.i = getelementptr inbounds nuw %"alloc::string::String", ptr %_1.val.i64, i64 %_3.sroa.0.011.i.i.i
  ...
  br i1 %64, label %_RINvNtCshhmRwEtsTQ2_4core3ptr13drop_in_placeNtNtCsavYRE6QVrtQ_5alloc6string6StringECsk5rB8Fy7VC3_12two_variants.exit.i.i.i, label %bb2.i.i.i4.i.i.i.i.i15

bb2.i.i.i4.i.i.i.i.i15:                           ; preds = %bb5.i.i.i
...
_RINvNtCshhmRwEtsTQ2_4core3ptr13drop_in_placeNtNtCsavYRE6QVrtQ_5alloc6string6StringECsk5rB8Fy7VC3_12two_variants.exit.i.i.i: ; preds = %bb2.i.i.i4.i.i.i.i.i15, %bb5.i.i.i
  %_7.i.i.i = icmp eq i64 %63, %_3.pre
  br i1 %_7.i.i.i, label %bb4.i, label %bb5.i.i.i

bb4.i:                                            ; preds = %_RINvNtCshhmRwEtsTQ2_4core3ptr13drop_in_placeNtNtCsavYRE6QVrtQ_5alloc6string6StringECsk5rB8Fy7VC3_12two_variants.exit.i.i.i, %bb11
  %_1.val.i65 = phi ptr [ %_35, %bb11 ], [ %_1.val.i64, %_RINvNtCshhmRwEtsTQ2_4core3ptr13drop_in_placeNtNtCsavYRE6QVrtQ_5alloc6string6StringECsk5rB8Fy7VC3_12two_variants.exit.i.i.i ]
...
; call __rustc::__rust_dealloc
  call void @_RNvCsl5Zt2FtcpFZ_7___rustc14___rust_dealloc(ptr noundef nonnull %_1.val.i65, i64 noundef %alloc_size.i.i.i.i7.i, i64 noundef range(i64 1, -9223372036854775807) 8) #22, !noalias !125
...
bb19:                                             ; preds = %_RNvXNtNtCsavYRE6QVrtQ_5alloc3vec21spec_from_iter_nestedINtB4_3VecNtNtB6_6string6StringEINtB2_18SpecFromIterNestedB11_NtNtCsefmIBSMl6ne_3std3env4ArgsE9from_iterCsk5rB8Fy7VC3_12two_variants.exit
  %67 = getelementptr inbounds nuw i8, ptr %args, i64 8
  %_35 = load ptr, ptr %67, align 8, !nonnull !4, !noundef !4
  %68 = getelementptr inbounds nuw i8, ptr %_35, i64 32
  %_50 = load ptr, ptr %68, align 8, !nonnull !4, !noundef !4
  %69 = getelementptr inbounds nuw i8, ptr %_35, i64 40
  %_49 = load i64, ptr %69, align 8, !noundef !4
  switch i64 %_49, label %bb9thread-pre-split.i [
    i64 0, label %bb2.i
    i64 1, label %bb7.i
  ]

bb7.i:                                            ; preds = %bb19
  %70 = load i8, ptr %_50, align 1, !alias.scope !132, !noalias !135, !noundef !4
...
bb9thread-pre-split.i:                            ; preds = %bb19
  %.pr.i = load i8, ptr %_50, align 1, !alias.scope !132, !noalias !135
  br label %bb9.i
...
bb9.i:                                            ; preds = %bb9thread-pre-split.i, %bb7.i
  ...
  %src.sroa.15.0.i = add nsw i64 %_49, %rest.1.i
  %src.sroa.0.0.idx.i = zext i1 %cond.i to i64
  %src.sroa.0.0.i = getelementptr inbounds nuw i8, ptr %_50, i64 %src.sroa.0.0.idx.i
...
bb16.i:                                           ; preds = %bb15.preheader.i, %bb20.i
  ...
  %_19.i17 = zext i8 %_20.i to i32
  %78 = add nsw i32 %_19.i17, -48
...
bb2.i:                                            ; preds = %bb33.i, %bb40.i, %bb16.i, %bb31.i, %bb19, %bb7.i, %bb7.i
  %_7.sroa.4.0.ph = phi i8 [ 1, %bb7.i ], [ 1, %bb7.i ], [ 0, %bb19 ], [ %spec.select, %bb31.i ], [ 1, %bb16.i ], [ 1, %bb33.i ], [ 2, %bb40.i ]
...
bb4:                                              ; preds = %bb22.i, %bb20.i
  %_7.sroa.1131.0 = phi i64 [ %80, %bb20.i ], [ %result.sroa.0.0.i, %bb22.i ]
  %_7.sroa.1131.0.fr = freeze i64 %_7.sroa.1131.0
  store i64 %_7.sroa.1131.0.fr, ptr %x, align 8
  %81 = icmp eq i64 %_7.sroa.1131.0.fr, 0
  br i1 %81, label %bb24.thread, label %bb24
...
bb7:                                              ; preds = %bb6
  ...
  store ptr %res, ptr %args2, align 8
  %_26.sroa.4.0..sroa_idx = getelementptr inbounds nuw i8, ptr %args2, i64 8
  store ptr @_RNvXsZ_NtNtCshhmRwEtsTQ2_4core3fmt3numjNtB7_5Debug3fmt, ptr %_26.sroa.4.0..sroa_idx, align 8
; invoke std::io::stdio::_print
  invoke void @_RNvNtNtCsefmIBSMl6ne_3std2io5stdio6__print(ptr noundef nonnull @alloc_0ea66dfa401483f8b62b25c396fda960, ptr noundef nonnull %args2)
...
bb9:                                              ; preds = %bb7
  ...
  %84 = load ptr, ptr %83, align 8, !invariant.load !4
  %.not.i22 = icmp eq ptr %84, null
  br i1 %.not.i22, label %bb3.i27, label %is_not_null.i23

is_not_null.i23:                                  ; preds = %bb9
  invoke void %84(ptr noundef nonnull inttoptr (i64 1 to ptr))
          to label %bb3.i27 unwind label %cleanup.i24

bb3.i27:                                          ; preds = %is_not_null.i23, %bb9
  %85 = getelementptr inbounds nuw i8, ptr %83, i64 8
  %86 = load i64, ptr %85, align 8, !range !8, !invariant.load !4
  %87 = getelementptr inbounds nuw i8, ptr %83, i64 16
  %88 = load i64, ptr %87, align 8, !range !9, !invariant.load !4
  %89 = add i64 %88, -1
  %90 = icmp sgt i64 %89, -1
  call void @llvm.assume(i1 %90)
  %91 = icmp eq i64 %86, 0
  br i1 %91, label %bb11, label %_RNvXs_NtCsavYRE6QVrtQ_5alloc5allocNtB4_6GlobalNtNtCshhmRwEtsTQ2_4core5alloc9Allocator10deallocate.exit.i.i28

_RNvXs_NtCsavYRE6QVrtQ_5alloc5allocNtB4_6GlobalNtNtCshhmRwEtsTQ2_4core5alloc9Allocator10deallocate.exit.i.i28: ; preds = %bb3.i27
; call __rustc::__rust_dealloc
  call void @_RNvCsl5Zt2FtcpFZ_7___rustc14___rust_dealloc(ptr noundef nonnull inttoptr (i64 1 to ptr), i64 noundef %86, i64 noundef range(i64 1, -9223372036854775807) %88) #22
  br label %bb11

cleanup.i24:                                      ; preds = %is_not_null.i23
  %92 = landingpad { ptr, i32 }
          cleanup
  %93 = getelementptr inbounds nuw i8, ptr %83, i64 8
  %94 = load i64, ptr %93, align 8, !range !8, !invariant.load !4
  %95 = getelementptr inbounds nuw i8, ptr %83, i64 16
  %96 = load i64, ptr %95, align 8, !range !9, !invariant.load !4
  %97 = add i64 %96, -1
  %98 = icmp sgt i64 %97, -1
  call void @llvm.assume(i1 %98)
  %99 = icmp eq i64 %94, 0
  br i1 %99, label %bb15, label %_RNvXs_NtCsavYRE6QVrtQ_5alloc5allocNtB4_6GlobalNtNtCshhmRwEtsTQ2_4core5alloc9Allocator10deallocate.exit.i4.i25

_RNvXs_NtCsavYRE6QVrtQ_5alloc5allocNtB4_6GlobalNtNtCshhmRwEtsTQ2_4core5alloc9Allocator10deallocate.exit.i4.i25: ; preds = %cleanup.i24
; call __rustc::__rust_dealloc
  call void @_RNvCsl5Zt2FtcpFZ_7___rustc14___rust_dealloc(ptr noundef nonnull inttoptr (i64 1 to ptr), i64 noundef %94, i64 noundef range(i64 1, -9223372036854775807) %96) #22
  br label %bb15

terminate:                                        ; preds = %cleanup4, %bb14
...
start:
  ...
  %reltable.intrinsic = call ptr @llvm.load.relative.i64(ptr @switch.table._RNvXs1g_NtCshhmRwEtsTQ2_4core3fmtRNtNtNtB8_3num5error12IntErrorKindNtB6_5Debug3fmtCsk5rB8Fy7VC3_12two_variants.29.rel, i64 %reltable.shift)
